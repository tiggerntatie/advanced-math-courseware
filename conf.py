# -*- coding: utf-8 -*-
#
# Advanced Math documentation build configuration file, created by
...
if target == 'html':
    ...
    extensions.extend(['sphinx.ext.pngmath'])
elif target == 'latex':
    extensions.extend(['rst2pdf.pdfbuilder'])
elif target == 'pdf':
    extensions.extend(['rst2pdf.pdfbuilder'])
...
html_title = "HHS Advanced Mathematics Textbook Project"
...
htmlhelp_basename = 'AdvancedMathdoc'
...
latex_documents = [
  ('index', 'AdvancedMathCourseware.tex', u'Advanced Math Courseware Documentation',
